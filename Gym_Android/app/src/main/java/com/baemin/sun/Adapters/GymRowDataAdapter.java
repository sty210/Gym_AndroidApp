 ...
 */
public class GymRowDataAdapter extends BaseAdapter {

    private ArrayList<GymsRowData> mDatas;
    private LayoutInflater mInflater;
    private Context mContext;

    public GymRowDataAdapter(Context context, LayoutInflater inflater, ArrayList<GymsRowData> datas) {
        this.mDatas= datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mViewholder.mTextView.setText(mDatas.get(position).getGymName());
